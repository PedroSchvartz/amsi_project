...
### 4.1 Edição para o Staff do Lançamento

- Desfazer um lançamento (voltando um passo na progressão, por exemplo de pago para efetivado)
- Permissão de editar data de pagamento e valor pago

### 4.2 Variável `APP_ENV` obrigatória no checklist de deploy
...
### 4.3 Bootstrap como comando Railway
