...
const ENDERECO_VAZIO = {
	...
	bairro: '', cidade: '', uf: '', cep: '', endereco_primario: true
};
...
function ClientRegister() {
	...
	const [telefones, setTelefones] = useState([{ tipo_contato: 'Telefone', info_do_contato: '', contato_principal: true }]);
	const [emails, setEmails]       = useState([{ tipo_contato: 'Email',    info_do_contato: '', contato_principal: true }]);
	...
	const handleSubmit = async (e) => {
		...
		const payload = {
			...
			enderecos: enderecos.map((end) => ({
				logradouro: end.logradouro.trim(), numero: end.numero.trim(),
				complemento: end.complemento.trim() || null,
				bairro: end.bairro.trim(), cidade: end.cidade.trim(),
				uf: end.uf, cep: end.cep.replace(/\D/g,''),
			...
			<form onSubmit={handleSubmit}>
					...
					<div className="client-form-card__body">
						...
						<div className="row g-3">
							<div className="col-12 col-md-6">
								...
								<input className={`form-control ${erros.nome?'is-invalid':''}`} name="nome" value={form.nome} onChange={handleChange} placeholder="Nome completo ou razão social" />
				...
				<div className="client-form-card">
					...
					<div className="client-form-card__body">
								...
								<div className="d-flex justify-content-between align-items-center mb-3">
									...
									<div className="d-flex gap-2">
										{!end.endereco_primario && (
											<button type="button" className="btn btn-sm btn-outline-secondary" onClick={() => toggleEnderecoPrimario(i)} title="Definir como principal">
						...
						<button type="button" className="client-form-btn-add" onClick={()=>setEnderecos([...enderecos,{...ENDERECO_VAZIO, endereco_primario:false}])}>
